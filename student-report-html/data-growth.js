...
window.GROWTH_STUDENTS = [
  {
    ...
    status: "",
    video: 68,
    unitScores: { video: 68, publishing: [60, 66, 68, 92, 80, 88, 78] },
  ...
  },
  {
    ...
    status: "중탈",
    video: 60,
    unitScores: { video: 60, publishing: [81, 82, 79, 95, 88, 89, 88] },
  ...
  },
  {
    ...
    status: "8/3취업",
    video: 79,
    unitScores: { video: 79, publishing: [91, 84, 81, 97, 87, 91, 83] },
  ...
  },
  {
    ...
    video: 93,
    unitScores: { video: 93, publishing: [67, 79, 85, 97, 84, 76, 88] },
  ...
  },
  {
    ...
    status: "",
    video: 82,
    unitScores: { video: 82, publishing: [77, 79, 85, 95, 82, 82, 80] },
  ...
  },
  {
    ...
    video: 60,
    unitScores: { video: 60, publishing: [67, 68, 68, 95, 70, 68, 80] },
  ...
  },
  {
    ...
    status: "",
    video: 77,
    unitScores: { video: 77, publishing: [95, 76, 83, 95, 84, 93, 91] },
  ...
  },
  {
    ...
    status: "",
    video: 62,
    unitScores: { video: 62, publishing: [83, 89, 88, 97, 88, 95, 90] },
  ...
  },
  {
    ...
    status: "",
    video: 80,
    unitScores: { video: 80, publishing: [67, 82, 70, 96, 80, 83, 98] },
    publishingAverage: 82.3,
    finalAverage: 85.7,
    selfCheck: 100,
    attendanceRate: 95.1,
  ...
  },
  {
    ...
    status: "",
    video: 95,
    unitScores: { video: 95, publishing: [75, 75, 73, 95, 86, 88, 98] },
    publishingAverage: 84.3,
    finalAverage: 85.9,
    selfCheck: 90,
    attendanceRate: 93.5,
  ...
  },
  {
    ...
    status: "",
    video: 93,
    unitScores: { video: 93, publishing: [90, 88, 78, 97, 89, 93, 87] },
  ...
  },
  {
    ...
    status: "",
    video: 95,
    unitScores: { video: 95, publishing: [96, 77, 88, 90, 89, 100, 98] },
