const CONFIG = {
  ...
  feedbackSpreadsheetId: '1mgA6LT6-Ny1a4xKM3xnmVcgIRo2DwajuDtsgNNo3MxY',
  feedbackSheetName: '훈련생 피드백',
  feedbackSpreadsheetUrl: 'https://docs.google.com/spreadsheets/d/1mgA6LT6-Ny1a4xKM3xnmVcgIRo2DwajuDtsgNNo3MxY/edit',
  rosterSpreadsheetId: '1KQtB9bGa6iBzFu-N1843eAB5z9B-j1yk1a_MOEu9Cp8',
  rosterSheetName: '프로젝트2',
...
function doGet(e) {
  ...
  return HtmlService
    .createHtmlOutput(buildProject2DashboardHtml_())
...
function buildProject2DashboardHtml_() {
  return `<!doctype html><html lang="ko"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>프로젝트2 어드민 모드</title><style>
