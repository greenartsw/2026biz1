...
function releaseStudent_(rowNumber, testOnly) {
  ...
  try {
    const isTest = testOnly === true || CONFIG.testMode === true;
    const sheet = getFeedbackSheet_();
    ensureReleaseColumns_(sheet);
